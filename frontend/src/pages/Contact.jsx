  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row mb-10 justify-center max-md:items-center gap-10">
        <img src={assets.contact_image} alt="contact_image" className="max-w-[360px]" />
        <div className="flex flex-col gap-4 text-gray-600 justify-center items-start">
          ...
          <button className="p-2 w-30 border-2 hover:bg-black hover:text-white rounded-sm cursor-pointer font-medium transition-all durtion-500 text-black">
            Explore Jobs
          </button>
        </div>
      </div>
